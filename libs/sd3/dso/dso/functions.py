...
unprotected_ops = [
    ...
    Token(coth, "coth", arity=1, complexity=4),
    Token(np.arcsin, "arcsin", arity=1, complexity=3),
    Token(np.arccos, "arccos", arity=1, complexity=3),
    Token(np.arctan, "arctan", arity=1, complexity=4),
    Token(np.cosh, "cosh", arity=1, complexity=3),
    Token(np.sinh, "sinh", arity=1, complexity=3),
