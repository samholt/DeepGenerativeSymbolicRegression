...
class DeepSymbolicOptimizer():
    ...
    def setup(self):
        ...
        self.controller = self.make_controller().to(DEVICE)
    ...
    def train(self):
        ...
        # Train the model & return dictionary of things to save for post-processing
        result = {"seed": self.config_experiment["seed"]}  # Seed listed first
        result.update(learn(self.controller,
                            self.pool,
                            self.gp_controller,
                            self.output_file,
    ...
    def set_config(self, config):
        ...
        self.config_controller["batch_size"] = self.config_training["batch_size"]
    ...
    def make_controller(self):
        controller = Controller(self.prior,
                                self.state_manager,
